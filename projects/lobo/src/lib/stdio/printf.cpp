    ...
    for (; *fmt; fmt++) {
        switch (state) {
            ...
            case 3:
                ...
                /* not modifier: advance state to check if it's a conversion
                 * char */
                state++;
                /* FALL THROUGH */
            ...
            case 4:
                ...
                *where = '\0';
                switch (*fmt) {
                    ...
                    DO_NUM:
                        if (flags & PR_32) num = va_arg(args, unsigned long);
...
/*****************************************************************************
*****************************************************************************/
int vprintf(const char *fmt, va_list args) { return do_printf(fmt, args, vprintf_help, NULL); }
